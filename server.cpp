...
class HelloServiceImpl final : public HelloService::Service {
  ...
  Status SayHello(ServerContext* context, const HelloReq* request, HelloResp* reply) override {
    reply->set_result("Hey, " + request->name() + "!");
    return Status::OK;
  }

  Status SayHelloStrict(ServerContext* context, const HelloReq* request, HelloResp* reply) override {
